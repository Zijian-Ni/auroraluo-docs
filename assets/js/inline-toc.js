...
(function(){
  ...
  function buildTOC(){
    ...
    hs.forEach(function(h){
      var id=h.id||(h.id=slugify(h.textContent||''));
  ...
  if (window.$docsify){
    window.$docsify.plugins=[].concat(function(hook){ hook.doneEach(function(){ setTimeout(buildTOC,100); }); }, window.$docsify.plugins||[]);
  }
